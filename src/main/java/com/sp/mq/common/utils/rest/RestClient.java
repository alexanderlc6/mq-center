package com.sp.mq.common.utils.rest;
...
public class RestClient {
    ...
    public String executeWithNoEncodeWithHeader(Map<String, String> reuqestHeader) throws RestException{
        if (null == this.serverUrl) {
            return null;
        }
        String ret = "";
        ...
        try {
            URL realUrl = new URL(this.serverUrl);
