package com.sp.mq.pojo;

import java.util.Properties;

/**
 * Created by alexlu on 2018/2/22.
 */
public class RestMessageInfo {
    ...
    public RestMessageInfo() {
    }

    public RestMessageInfo(String tag, String topic, Properties userProperties, Properties systemProperties, String serviceUrl, Object requestData) {
        this.tag = tag;
        this.topic = topic;
